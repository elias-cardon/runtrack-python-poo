...
class Personne:
    ...
    # Méthode pour afficher 'Bonjour' en console
    def bonjour(self):
        print("Bonjour")
...
# Instancier un objet Eleve avec l'âge par défaut (14 ans)
eleve1 = Eleve()
...
# Afficher le nouvel âge de l'élève en console
eleve1.affichageAge()

# Instancier un objet Professeur avec la matière enseignée "Mathématiques" et 40 ans
